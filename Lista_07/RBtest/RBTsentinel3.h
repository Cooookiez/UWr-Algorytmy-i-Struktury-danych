...
{	
	...
	RBTsentinel3():root(&NIL),NIL(0,true,&NIL,&NIL){}
	~RBTsentinel3(){destroy(root);}
	...
	void insert(int x) // wersja z nowego Cormena
	{	
		node * p=&NIL;
		node *t=root;
	...
	void insert2(int x) // wersja ze starego Cormena
	{		
		if(root==&NIL)
